...
//Ex3
	...
	public void uploadByRobot(WebDriver driver, String locator, String value) throws InterruptedException, Exception {
...
//	}
	...
	public Object removeAttribute(WebDriver driver, String locator, String attribute) {
		WebElement element = driver.findElement(By.xpath(locator));
		JavascriptExecutor js = (JavascriptExecutor) driver;
